...
def main():
    ...
    if PARAM['weight'] == 'U':
        ...
        z = np.random.normal(0.5, 0.25, size=PARAM['num_nodes'])
    elif PARAM['weight'] == 'B':
        z = np.random.binomial(1, 0.5, size=PARAM['num_nodes'])
    ...
    dt_train = pd.concat([uz, y0, y1, influence], axis=1)
...
PARAM = {
    ...
    # Default: N-None
    # [D][E] U-Uniform
    # [L] B-Binary, U-Uniform distribution, Z-Normal distribution
    'weight': 'N',
